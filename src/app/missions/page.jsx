            ...
            <div>
              <section className=" bg-blue-500ray-50">
                <div className="py-10  sm:py-16 block lg:py-24 relative bg-opacity-50  z-40  ">
                  <div className="relative mx-auto h-full px-0 pb-20  md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
                    <div className="px-0 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
                      <div className="max-w-xl text-left">
                        <div className="inline-flex px-0 mx-auto rounded-full  ">
                          <p
                            className="text-4xl tracking-widest text-g font-corben text-[24px] font-bold"
                            data-aos="fade-up">
                      ...
                      <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20 ">
                        <a
                          data-aos="fade-up"
                          href="/missions/pmsp"
                          className="transition-all  duration-1000 bg-white hover:bg-blue-500  hover:shadow-xl m-2 p-4 relative z-40 group  shadow-[0px_8px_24px_rgba(149,157,165,0.2)]">
                          ...
                          <div className="py-2 px-3 md:px-9 relative">
                            <svg
                            ...
                            <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white font-josefin_sans">
                              Partial Missionary Sponsorship Program
                            </h3>
                            <p className="mt-4 text-base text-gray-600 group-hover:text-white font-raleway">
                        ...
                        <a
                          ...
                          <div className="py-2 px-3 md:px-9 relative">
                            ...
                            <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white font-montserrat">
                        ...
                        <a
                          ...
                          <div className="py-2 px-3 md:px-9 relative">
                            ...
                            <h3 className="mt-8 text-lg font-semibold text-black group-hover:text-white font-ubuntu">
                              Mission Teams
                            </h3>
                            <p className="mt-4 text-base text-gray-600 group-hover:text-white font-raleway">
                              Amet minim mollit non deserunt ullamco est sit
